...
%{_sbindir}/semanage port -a -t sucrecoin_port_t -p tcp 8766
%{_sbindir}/semanage port -a -t sucrecoin_port_t -p tcp 8767
%{_sbindir}/semanage port -a -t sucrecoin_port_t -p tcp 18766
%{_sbindir}/semanage port -a -t sucrecoin_port_t -p tcp 18767
